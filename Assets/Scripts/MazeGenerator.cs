...
public class MazeGenerator : MonoBehaviour
{
    ...
    void Start()
    {   
        //Cell wall 0,-1 is north, wall 0,1 is south, wall 1,0 is east, wall -1,0 is west

        cell_walls[new Vector2(0, -1)] = N;     //cell_walls[new Vector2(0, -1)] = N;
        cell_walls[new Vector2(1, 0)] = E;      //cell_walls[new Vector2(1, 0)] = E;
        cell_walls[new Vector2(0, 1)] = S;      //cell_walls[new Vector2(0, 1)] = S;
        cell_walls[new Vector2(-1, 0)] = W;     //cell_walls[new Vector2(-1, 0)] = W;
    ...
    private void MakeMaze()
    {
        ...
        for (int i = 0; i < width; i++)  //from 0 - 2
        {
            map.Add(new List<int>());
            for (int j = 0; j < height; j++)    //from 0 - 2
            {
                map[i].Add(N | E | S | W);      //Adds 15 to list i in map
